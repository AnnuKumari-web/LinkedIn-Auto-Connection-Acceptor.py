...
driver.find_element(By.ID,"session_key").send_keys("ENTER YOUR EMAIL")
driver.find_element(By.ID,"session_password").clear()
driver.find_element(By.ID,"session_password").send_keys("ENTER YOUR PASSWORD")
driver.find_element(By.CLASS_NAME,"sign-in-form__submit-button").click()
time.sleep(1)
#assert feed in driver.current_url
driver.find_element(By.ID,"ember21").click()
